...
A personal Windows Command Palette extension that scans your [WezTerm](https://wezterm.org/) configuration files to automatically discover your custom profiles and lets you launch them directly.

---

## Features

- **Profile Discovery**: Scans and locates WezTerm profiles from your `.lua` configuration files.
